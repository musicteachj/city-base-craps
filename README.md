...
So, if a value of 9 was rolled in the first round, the player must roll 9 again *before* rolling 7 to win. A player may roll the dice as many times as necessary until they either roll the number 9 or the number 7.
